 ...
 * 
 * @see IBeaconManager#setRangeNotifier(com.radiusnetworks.ibeacon.RangeNotifier notifier)
 * @see IBeaconManager#startRangingBeaconsInRegion(com.radiusnetworks.ibeacon.Region region)
